...
const TERMS_OF_SERVICE_SECTIONS = [
  {
    ...
    lastUpdated: true,
    paragraphs: [
      "Please read these Terms of Service (\"Terms,\" \"Terms of Service\") carefully before using the SEEFA mobile application (the \"Service,\" \"App\") operated by [Your Business Name/Developer Name, if applicable] (\"us,\" \"we,\" or \"our\").",
